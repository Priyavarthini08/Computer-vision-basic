...
args.add_argument("--mode", default='webcam')#we will have argument which user can set in dif mode like video,webcam,image
args.add_argument("--filePath", default=None)#specify img path
